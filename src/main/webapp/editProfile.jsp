                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <form action="EditProfile" method="POST">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0"><fmt:message key="editProfile.birthDate"/></h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <input type="date" class="form-control" placeholder="${sessionScope.loggedUser.birthDate}" name="birthDate" required>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0"><fmt:message key="editProfile.gender"/></h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <select class="form-control" name="gender" required>
                                        <option value="1"><fmt:message key="editProfile.male"/></option>
                                        <option value="2"><fmt:message key="editProfile.female"/></option>
                                    </select>
                                </div>
                            </div>
                            <hr>
